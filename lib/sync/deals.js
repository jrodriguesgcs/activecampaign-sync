// lib/sync/deals.js
const { fetchFirstPage, fetchPage, fetchMetadata } = require('../activecampaign/client');
const { fetchAllPages } = require('../utils/rate-limiter');
const { storeDealsData } = require('../db/storage');
 ...
 */
async function syncDeals(syncId) {
